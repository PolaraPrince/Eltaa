...
<!-- Mirrored from themes.potenzaglobalsolutions.com/html/it-infinite/careers.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 08 Jan 2025 18:09:12 GMT -->
<head>
    <meta charset="utf-8">
            ...
            <ul class="main-menu">
              ...
              <li class="nav-item active"><a class="nav-link" href="#">Pages <i class="fa-solid fa-chevron-down"></i></a>
                <ul class="submenu">
                  ...
                  <li><a class="nav-link active" href="careers.html">Careers</a></li>
            ...
            <div class="container">
              <div class="row">
                <div class="col-md-5 mb-5 mb-md-0">
                  <img class="img-fluid mx-lg-5 radius-10" src="images/about/about-04.jpg" alt="#">
                </div>
                <div class="col-md-7">
                  <div class="section-title pe-xl-5">
                    <span class="sub-title"><img class="img-fluid" src="images/subtitle-icon.png" alt=""> About Us</span>
                    <h2 class="title"> We enable constant enterprise transformation at speed and scale. </h2>
                  </div>
                  <div class="ps-sm-5">
                    ...
                    <div class="list-wrapper">
                     <ul class="list">
                        <li><img class="img-fluid" src="images/arrow-right.png" alt="">Success is something of which we all want more</li>
                        <li><img class="img-fluid" src="images/arrow-right.png" alt="">Most people believe that success is difficult</li>
                        <li><img class="img-fluid" src="images/arrow-right.png" alt="">There are basically six key areas to higher achievement</li>
                        <li><img class="img-fluid" src="images/arrow-right.png" alt="">Believing in yourself and those around you</li>
                        <li><img class="img-fluid" src="images/arrow-right.png" alt="">Making a decision to do something</li>
                      </ul>
                     </div>
                  </div>
                </div>
              ...
              <div class="row justify-content-center">
                <div class="col-md-10">
                  <div class="section-title text-center">
                    <span class="sub-title justify-content-center"><img class="img-fluid" src="images/subtitle-icon.png" alt=""> Open positions</span>
                   ...
                   <div class="col-lg-12">
                    <div class="find-job-wrapper">
                       <div class="find-job-item">
                          <div class="job-title"><h4 class="awards-name">Web Designer</h4></div>
                          <div class="job-details">
                             <div class="job-image"><img class="img-fluid" src="images/jobs/01.jpg" alt="" /></div>
                             <div class="job-content">
                                <div class="job-time">Full Time</div>
                                <div class="job-location">Location : <span>London</span></div>
                                <div class="job-desc">What steps are required to get you to the goals? Make the plan as detailed as possible. Try to visualize and then plan for, every possible setback.</div>
                                <div class="job-info">
                                   <div class="info-item info-experience">Experience : <span>5 Year</span></div>
                                   <div class="info-item info-salary">Salary : <span>$55000</span></div>
                                   <div class="info-item info-deadline">Deadline : <span>20 Jan 2022</span></div>
                                </div>
                             </div>
                       ...
                       <div class="find-job-item">
                          <div class="job-title"><h4 class="awards-name">IOS developer</h4></div>
                          <div class="job-details">
                             <div class="job-image"><img class="img-fluid" src="images/jobs/02.jpg" alt="" /></div>
                             <div class="job-content">
                                <div class="job-time">Full Time</div>
                                <div class="job-location">Location : <span>London</span></div>
                                <div class="job-desc">What steps are required to get you to the goals? Make the plan as detailed as possible. Try to visualize and then plan for, every possible setback.</div>
                       ...
                       <div class="find-job-item">
                          <div class="job-title"><h4 class="awards-name">PHP developer</h4></div>
                          <div class="job-details">
                             <div class="job-image"><img class="img-fluid" src="images/jobs/03.jpg" alt="" /></div>
                             <div class="job-content">
                                <div class="job-time">Full Time</div>
                                <div class="job-location">Location : <span>London</span></div>
                                <div class="job-desc">What steps are required to get you to the goals? Make the plan as detailed as possible. Try to visualize and then plan for, every possible setback.</div>
                    ...
                    <div class="steps-wrapper">
                      <div class="steps-item">
                        ...
                        <div class="step-info">
                          ...
                          <h3 class="step-title">We Know Your Business Already</h3>
                      ...
                      <div class="steps-item">
                        ...
                        <div class="step-info">
                          ...
                          <h3 class="step-title">Building Context – Not Just Code</h3>
                      ...
                      <div class="steps-item">
                        ...
                        <div class="step-info">
                          ...
                          <h3 class="step-title">We Are Responsive And Flexible</h3>
                      ...
                      <div class="steps-item">
                        ...
                        <div class="step-info">
                          ...
                          <h3 class="step-title">10 Years Experience – And Counting</h3>
                          <p>Get the oars in the water and start rowing. Execution is the single biggest factor in achievement.</p>
                          <div class="list-wrapper">
                            <ul class="step-list list col-2">
                              <li><img class="img-fluid" src="images/arrow-right.png" alt="" />Digital PR</li>
                          ...
                          <div class="step-image"><img class="img-fluid" src="images/steps/04.png" alt=""></div>
                        </div>
                      </div>
...
<!-- Mirrored from themes.potenzaglobalsolutions.com/html/it-infinite/careers.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 08 Jan 2025 18:09:13 GMT -->
</html>
