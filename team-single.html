...
<!-- Mirrored from themes.potenzaglobalsolutions.com/html/it-infinite/team-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 08 Jan 2025 18:09:18 GMT -->
<head>
    <meta charset="utf-8">
            ...
            <ul class="main-menu">
              ...
              <li class="nav-item active"><a class="nav-link" href="#">Pages <i class="fa-solid fa-chevron-down"></i></a>
                <ul class="submenu">
                  ...
                  <li><a class="nav-link active" href="team-single.html">Team Single</a></li>
              ...
              <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li><a class="dropdown-item active" href="team-single.html">Team Single</a></li>
              ...
              <div class="row justify-content-center">
                <div class="col-lg-10">
                   <div class="section-title mb-4">
                      <h3 class="title mb-2">Anne Smith</h3>
                      <p>Senior Software Engineer</p>
                   </div>
                </div>
              </div>
              <div class="row justify-content-center">
                <div class="col-lg-4 col-md-5">
                  <div class="team-style-1">
                    <img class="img-fluid rounded" src="images/team/01.jpg" alt="Member Image" />
                ...
                <div class="col-lg-6 col-md-7 ps-3 ps-md-5 mt-5 mt-md-0">
                  <div class="skill-wrapper mb-5">
                    ...
                    <div class="skill skill-style-2">
                      <div class="skill-bar" data-percent="45" data-delay="0" data-type="%">
                        <div class="skill-title">Javascript</div>
                      </div>
                    </div>
                    <div class="skill skill-style-2">
                      <div class="skill-bar" data-percent="95" data-delay="0" data-type="%">
                        <div class="skill-title">CSS, HTML5</div>
                      </div>
                    </div>
                  </div>
                  <h4 class="title">Biography</h4>
                  <p>So how do we get clarity? Simply by asking ourselves lots of questions: What do I really want? What does success look like to me? Why do I want a particular thing? How will this achievement change my life? How can I use this success to make a difference for others?</p>
                  <p>The best way is to develop and follow a plan. Start with your goals in mind and then work backwards to develop the plan. What steps are required to get you to the goals? Make the plan as detailed as possible.</p>
                </div>
              </div>
            </div>
          </section>
