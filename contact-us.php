...
<!-- Mirrored from themes.potenzaglobalsolutions.com/html/it-infinite/contact-us.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 08 Jan 2025 18:09:13 GMT -->
<head>
    <meta charset="utf-8">
              ...
              <div class="row">
                <div class="col-xl-6 col-lg-5">
                  <div class="section-title is-sticky">
                    <span class="sub-title"><img class="img-fluid" src="images/subtitle-icon.png" alt=""> Our Direction</span>
                  ...
                  <div class="location-items grid-wrapper grid-xl-2 grid-lg-2 grid-md-2 grid-sm-2 grid-xs-1">
                      ...
                      <div class="location-inner">
                        <div class="location-info">
                          <div class="city-image">
                            <img class="img-fluid" src="images/city-shanghai.png" alt="">
                          </div>
                          <div class="city-info">
                            <h5 class="city-name"><a href="#">Shanghai</a></h5>
                            <div class="city-location">
                              <div class="location-item">
                                <i class="icon"><img class="img-fluid" src="images/icon-location.png" alt=""></i>
                                <div class="list-label">214 West Arnold St. New York, NY 10002</div>
                              </div>
                              <div class="location-item">
                                <i class="icon"><img class="img-fluid" src="images/icon-phone-call.png" alt=""></i>
                                <div class="list-label">+(123) 456-7890</div>
                              </div>
                              <div class="location-item">
                                <i class="icon"><img class="img-fluid" src="images/icon-email.png" alt=""></i>
                    ...
                    <div class="location-wrapper location-style-1 bg-black">
                      <div class="location-inner">
                        <div class="location-info">
                          <div class="city-image">
                            <img class="img-fluid" src="images/city-frankfurt.png" alt="">
                          </div>
                          <div class="city-info">
                            <h5 class="city-name"><a href="#">Frankfurt</a></h5>
                            <div class="city-location">
                              <div class="location-item">
                                <i class="icon"><img class="img-fluid" src="images/icon-location.png" alt=""></i>
                                <div class="list-label">214 West Arnold St. New York, NY 10002</div>
                    ...
                    <div class="location-wrapper location-style-1 bg-black">
                      <div class="location-inner">
                        <div class="location-info">
                          <div class="city-image">
                            <img class="img-fluid" src="images/city-chicago.png" alt="">
                          </div>
                          <div class="city-info">
                            <h5 class="city-name"><a href="#">Chicago</a></h5>
                            <div class="city-location">
                              <div class="location-item">
                                <i class="icon"><img class="img-fluid" src="images/icon-location.png" alt=""></i>
                                <div class="list-label">214 West Arnold St. New York, NY 10002</div>
                    ...
                    <div class="location-wrapper location-style-1 bg-black">
                      <div class="location-inner">
                        <div class="location-info">
                          <div class="city-image">
                            <img class="img-fluid" src="images/city-new-york.png" alt="">
                          </div>
                          <div class="city-info">
                            <h5 class="city-name"><a href="#">New York</a></h5>
                            <div class="city-location">
                              <div class="location-item">
                                <i class="icon"><img class="img-fluid" src="images/icon-location.png" alt=""></i>
                                <div class="list-label">214 West Arnold St. New York, NY 10002</div>
                ...
                <div class="row justify-content-center">
                  <div class="col-md-10">
                    <div class="section-title text-center">
                      <span class="sub-title d-flex justify-content-center"><img class="img-fluid" src="images/subtitle-icon.png" alt=""> contact us</span>
...
<!-- Mirrored from themes.potenzaglobalsolutions.com/html/it-infinite/contact-us.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 08 Jan 2025 18:09:14 GMT -->
</html>
