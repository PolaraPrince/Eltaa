...
<!-- Mirrored from themes.potenzaglobalsolutions.com/html/it-infinite/service-detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 08 Jan 2025 18:09:19 GMT -->
<head>
    <meta charset="utf-8">
        ...
        <div class="header-inner">
          ...
          <div class="site-menu d-none d-xl-block">
            <ul class="main-menu">
              ...
              <li class="nav-item active"><a class="nav-link" href="#">Service <i class="fa-solid fa-chevron-down"></i></a>
                <ul class="submenu">
                  <li><a class="nav-link" href="service.html">Service</a></li>
                  <li><a class="nav-link active" href="service-detail.html">Service Single</a></li>
                </ul>
              </li>
              ...
              <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li><a class="dropdown-item active" href="service-detail.html">Service Single</a></li>
                  </ul>
                </li>
                <li class="nav-item dropdown">
                 ...
                 <div class="sidebar is-sticky">
                  <div class="widget widget-categories">
                   ...
                   <div class="widget categories-widget">
                    <h5 class="widget-title">For those of you who are serious about having more.</h5>
                    <ul class="address-info-list mb-0">
                      <li><h6><img class="img-fluid" src="images/svg/phone-call.svg" alt="">+(123) 456-7890</h6></li>
                      <li><h6><img class="img-fluid" src="images/svg/email.svg" alt="">letstalk@worthy.com</h6></li>
                    </ul>
                   </div>
                 </div>
                </div>
                ...
                <div class="col-lg-8 mt-5 mt-lg-0">
                  <div class="service-single">
                    <div class="service-img">
                      <img class="img-fluid" src="images/service/service-single-01.jpg" alt="">
                    </div>
                    <div class="service-content ps-0 ps-md-5 mt-5">
                      ...
                      <div class="description">
                        ...
                        <div class="list-wrapper py-4">
                          <ul class="list col-2 col-xs-1">
                            <li><img class="img-fluid" src="images/arrow-right.png" alt="">For those of you who are serious about having more.</li>
                            <li><img class="img-fluid" src="images/arrow-right.png" alt="">This is the beginning of creating the life that you want to live.</li>
                      ...
                      <div class="row">
                        <div class="col-md-5">
                          <img class="img-fluid" src="images/service/service-single-02.jpg" alt="#">
                        </div>
                        <div class="col-md-7 mt-4 mt-md-0">
                          <div class="list-wrapper mb-5">
                          <ul class="list">
                            <li><img class="img-fluid" src="images/arrow-right.png" alt="">Making the decision</li>
                            <li><img class="img-fluid" src="images/arrow-right.png" alt="">Clarity developing the vision</li>
                            <li><img class="img-fluid" src="images/arrow-right.png" alt="">Focus having a plan</li>
                            <li><img class="img-fluid" src="images/arrow-right.png" alt="">From my perspective then</li>
                            <li><img class="img-fluid" src="images/arrow-right.png" alt="">Just to bring it into focus</li>
                            <li><img class="img-fluid" src="images/arrow-right.png" alt="">Just to bring it into focus</li>
                          </ul>
                        </div>
                        <img class="img-fluid" src="images/service/service-single-03.png" alt="#">
                        </div>
                      </div>
                      <div class="section-title mt-5">
                        <span class="sub-title"><img class="img-fluid" src="images/subtitle-icon.png" alt=""> FAQ</span>
...
<!-- Mirrored from themes.potenzaglobalsolutions.com/html/it-infinite/service-detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 08 Jan 2025 18:09:20 GMT -->
</html>
