...
<!-- Mirrored from themes.potenzaglobalsolutions.com/html/it-infinite/team.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 08 Jan 2025 18:09:15 GMT -->
<head>
    <meta charset="utf-8">
              ...
              <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li><a class="dropdown-item" href="events-detail.html">Events Single</a></li>
                ...
                <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="locations.html">Locations 01</a></li>
                    <li><a class="dropdown-item" href="locations-02.html">Locations 02</a></li>
                    <li><a class="dropdown-item" href="locations-detail.html">Locations Single</a></li>
                  </ul>
                </li>
                <li class="nav-item dropdown">
                  <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">Workplaces</a>
                  <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="workplaces.html">Workplaces 01</a></li>
                    <li><a class="dropdown-item" href="workplaces-02.html">Workplaces 02</a></li>
                    <li><a class="dropdown-item" href="workplaces-detail.html">Workplaces Single</a></li>
                  </ul>
                </li>
                <li class="nav-item dropdown">
      ...
      <div class="site-content">
        ...
        <div class="content-wrapper">
                  ...
                  <div class="team-boxs grid-wrapper grid-xl-4 grid-lg-3 grid-md-2 grid-sm-2 grid-xs-1">
                    <div class="team-item team-style-1">
                      ...
                      <div class="team-info">
                        ...
                        <span class="team-destination">Senior Software Engineer</span>
                    ...
                    <div class="team-item team-style-1">
                      ...
                      <div class="team-info">
                        ...
                        <span class="team-destination">IT Project Manager</span>
                        <div class="team-social">
                          <ul>
                            <li><a href="#">Fb</a></li>
                            <li><a href="#">Dr</a></li>
                    ...
                    <div class="team-item team-style-1">
                      ...
                      <div class="team-info">
                        ...
                        <span class="team-destination">Network Engineer</span>
                        <div class="team-social">
                          <ul>
                            <li><a href="#">Fb</a></li>
                            <li><a href="#">Dr</a></li>
                    ...
                    <div class="team-item team-style-1">
                      ...
                      <div class="team-info">
                        ...
                        <span class="team-destination">Frontend Developer</span>
                        <div class="team-social">
                          <ul>
                            <li><a href="#">Fb</a></li>
                            <li><a href="#">Dr</a></li>
                    ...
                    <div class="team-item team-style-1">
                      ...
                      <div class="team-info">
                        <a href="team-detail.html" class="team-title">Michael Davis</a>
                        <span class="team-destination">Data Analyst</span>
                        <div class="team-social">
                          <ul>
                            <li><a href="#">Fb</a></li>
                            <li><a href="#">Dr</a></li>
                    ...
                    <div class="team-item team-style-1">
                      ...
                      <div class="team-info">
                        <a href="team-detail.html" class="team-title">Samantha Brown</a>
                        <span class="team-destination">Quality Assurance</span>
                        <div class="team-social">
                          <ul>
                            <li><a href="#">Fb</a></li>
                            <li><a href="#">Dr</a></li>
                    ...
                    <div class="team-item team-style-1">
                      ...
                      <div class="team-info">
                        <a href="team-detail.html" class="team-title">Kevin Lee</a>
                        <span class="team-destination"> IT Support</span>
                        <div class="team-social">
                          <ul>
                            <li><a href="#">Fb</a></li>
                            <li><a href="#">Dr</a></li>
                    ...
                    <div class="team-item team-style-1">
                      ...
                      <div class="team-info">
                        <a href="team-detail.html" class="team-title">Ashley Williams</a>
                        <span class="team-destination"> Systems Administrator</span>
                        <div class="team-social">
                          <ul>
                            <li><a href="#">Fb</a></li>
                            <li><a href="#">Dr</a></li>
          ...
          Our Staff -->
                    ...
                    <!--=================================
          Our Testimonial -->
          <section class="space-pt testimonial-section overflow-hidden ellipse-top">
...
<!-- Mirrored from themes.potenzaglobalsolutions.com/html/it-infinite/team.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 08 Jan 2025 18:09:18 GMT -->
</html>
