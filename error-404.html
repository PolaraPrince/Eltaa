...
<!-- Mirrored from themes.potenzaglobalsolutions.com/html/it-infinite/error-404.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 08 Jan 2025 18:09:18 GMT -->
<head>
    <meta charset="utf-8">
            ...
            <ul class="main-menu">
              ...
              <li class="nav-item active"><a class="nav-link" href="#">Pages <i class="fa-solid fa-chevron-down"></i></a>
                <ul class="submenu">
                  ...
                  <li><a class="nav-link active" href="error-404.html">Error 404</a></li>
              ...
              <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li><a class="dropdown-item active" href="error-404.html">Error 404</a></li>
                ...
                <div class="col-lg-10">
                  <div class="error-content text-center">
                    <div class="error-main-title">
                     ...
                     <img class="smile-icon" src="images/svg/smile-icon.svg" alt="#">
                    </div>
                    ...
                    <a class="btn btn-effect" href="index.html">
