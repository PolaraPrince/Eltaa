...
<!-- Mirrored from themes.potenzaglobalsolutions.com/html/it-infinite/case-studies.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 08 Jan 2025 18:09:20 GMT -->
<head>
    <meta charset="utf-8">
            ...
            <nav class="navbar">
              <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu">
                    <li><a class="dropdown-item active" href="case-studies.html">Case Studies</a></li>
              ...
              <div class="row justify-content-start">
                <div class="col-lg-12">
                  <div class="case-studies-grid grid-wrapper grid-xl-3 grid-md-2 grid-sm-1">
                    ...
                    <div class="case-studies-wrapper case-studies-style-1">
                      <div class="case-studies-img">
                        <img class="img-fluid" src="images/case-studies/06.png" alt="" />
                        <a href="#" class="category">Food</a>
                      </div>
                      <div class="case-studies-info">
                        <div class="case-studies-info-inner">
                          <h3 class="case-studies-title"><a href="#">Foodocity</a></h3>
                           <div class="case-studies-content">
                            <div class="case-studies-description">Some people will tell you there are four while others may tell you there are eight.</div>
                           </div>
                           <div class="case-studies-link">
